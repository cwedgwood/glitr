...
| `storage` | volumes as sparse files, reflink (`FICLONE`) snapshots, a crash-safe record store |
| `appliance` | the demonstration: volumes, hosts, LUN mapping and a REST control plane over everything above |
